...
# Vyper does not allow dynamic arrays
# Therefore we limite the number of bids that can be placed by and address to 128
...
# invalid bids and for all bids except ofr the totally highest.
@external
def reveal(_numBids: int128, _values: uint256[128], _fakes: bool[128], _secrets: bytes32[128]):
    ...
    for i in range(MAX_BIDS):
        ...
        # Bid was not revealed. Do not refund deposit.
...
def auctionEnd():
    ...
    # Check that auction has not already maarked as ended
